...
namespace FormUI
{
    class DataAccess
    {
        ...
        public List<Person> GetPeople(string lastnamein)
        {
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Helper.CnnVal("SqlExpress2014")))
            {
            ...
            {
                using (IDbConnection connectionAgain = new System.Data.SqlClient.SqlConnection(Helper.CnnVal("SqlExpress2005")))
                {
